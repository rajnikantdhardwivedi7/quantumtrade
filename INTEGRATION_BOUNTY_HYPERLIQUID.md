...
## 📋 Overview
We're looking for contributors to add Hyperliquid exchange support to QuantumTrade OS. Currently supports Binance Futures, seeking to expand to Hyperliquid perpetual contracts.
...
- Contact: [@dharrajnikant](https://x.com/dharrajnikant) on Twitter
